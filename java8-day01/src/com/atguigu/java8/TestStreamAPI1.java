...
public class TestStreamAPI1 {
	...
	List<Employee> emps = Arrays.asList(
			...
			new Employee(102, "李四", 58, 5999.55, Status.BUSY),
			new Employee(103, "王五", 16, 3333.33, Status.VOCATION),
			new Employee(104, "赵六", 8, 6666.66, Status.BUSY),
			new Employee(105, "田七", 98, 8888.88, Status.FREE),
			new Employee(103, "王五", 16, 3333.33, Status.VOCATION)
	);
